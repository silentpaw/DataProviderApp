...
public class MyContentProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.dataproviderapp.provider";
    ...
    private void addInitialData() {
        ...
        values.put("name", "Test Name 1");
        database.insert("data", null, values);

        values.put("name", "Test Name 2");
        database.insert("data", null, values);

        values.put("name", "Test Name 3");
        database.insert("data", null, values);
